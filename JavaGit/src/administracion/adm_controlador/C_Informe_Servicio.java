...
import administracion.adm_modelo.M_Informe_Servicio;
import administracion.adm_modelo.M_Cliente;
import administracion.adm_modelo.M_Detalle_Informe;
import administracion.adm_modelo.M_Equipo;
import administracion.adm_vista.V_Informe_Servicio;
        ...
        // *****************************************************************************************
            ...
            if (fila >= 0) {
                new C_Trabajo(this.informe_seleccionado, Integer.parseInt(vista_informe_servicio.tabla_detalle.getValueAt(fila, 0).toString()), this.estado, 
                        vista_informe_servicio.tabla_detalle.getValueAt(fila, 1).toString() + 
                                " - " + vista_informe_servicio.tabla_detalle.getValueAt(fila, 2).toString() + 
                                " - " + vista_informe_servicio.tabla_detalle.getValueAt(fila, 3).toString()
                );
